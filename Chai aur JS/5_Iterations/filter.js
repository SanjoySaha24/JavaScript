// const coding = ["ab", "lo", "wad", "lpl", 'qee']
...
// const coding = [1,2,3,4,5, 6, -9, 77, 9, 8]
// const newNums = coding.filter( (num) => num>4)
// console.log(newNums);


// const coding = [1,2,3,4,5, 6, -9, 77, 9, 8]
// const newNums = coding.filter( (num) => { // scope, use return keyword
//     return num>4
// }
// )
// console.log(newNums);
...
// const myNums = [1,2,3,4,5, 6, -9, 77, 9, 8]
// const newNums = []
// myNums.forEach( (num)=> {
//     if(num>4){
//         newNums.push(num)
